...
| `docs/agent-viewer-modes.md` | Session / Prompt / Info / Output overlay: picker, `s` `p` `i` `o` keys, spawn-prompt storage. Source: `src/ui/agent-views.ts`, `src/ui/conversation-viewer.ts`. |
